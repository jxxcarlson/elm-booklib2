module Pages.Invitations exposing (Model, Msg(..), acceptButton, acceptInvitation, footer, init, inset, invitationListView, mainView, rejectButton, rejectInvitation, update, view, viewInvitation, windowInset)
...
invitationListView sharedState model =
    column
        ...
        , Border.width 1
        , padding 8
        , Background.color (Style.makeGrey 0.95)
        ]
...
viewInvitation invitation =
    row [ spacing 12 ]
        [ el [ Font.size 14 ] (text <| invitation.inviter ++ " invites you to join the " ++ invitation.groupName ++ " group.")
